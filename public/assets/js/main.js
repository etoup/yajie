        ...
        $form.validate({
            ...
            submitHandler: function (form) {
                $(form).ajaxSubmit({
                    ...
                    success: function (data) {
                        ...
                        $formNotify.removeClass('valid error').addClass('valid').html('<i class="fa fa-check-square"></i>提交成功，请保持电话畅通我们将稍后联系您！').show();
                        //} else {
                        //  $formNotify.removeClass('valid error').addClass('error').html(data.message).show();
                        //}
                    },
                    error: function (data) {
                        $formNotify.removeClass('valid').addClass('success').html('<i class="fa fa-warning"></i>提交失败，请重试！').show();
                    },
                });
            },
            invalidHandler: function (event, validator) {
                ...
                if (errors) {
                    ...
                    '<i class="fa fa-warning"></i>请填写完整的联系信息！' :
                    '<i class="fa fa-warning"></i>有' + errors + '项还没有填写！';
