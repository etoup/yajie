...
function() {
        ...
        e = function(a, b, c, d, e, f, g, h, i, j, k, l) {
            ...
            var o = function(f, o) {
                ...
                this.trigger = function(a, b) {
                    return b = g.isObject(b) ? g.extend({},
                    b) : {},
                    b.type = a,
                    window.jwplayer && window.jwplayer.debug ? c.trigger.call(q, a, b) : c.triggerSafe.call(q, a, b)
                },
    ...
    function(a, b, c) {
        ...
        e = function() {
            ...
            s.partial = function(a) {
                ...
                return function() {
                    for (var c = 0,
                    d = b.slice(), e = 0, f = d.length; f > e; e++) d[e] === s && (d[e] = arguments[c++]);
    ...
    function(a, b, c) {
        var d, e;
        d = [c(72), c(115), c(74), c(44), c(93), c(111), c(77), c(114), c(64), c(47), c(116), c(46), c(76), c(61), c(45), c(156)],
            ...
            return s.prototype = {
                ...
                setup: function(g, l) {
                    ...
                    function q() {
                        ...
                        V.on("change:castState",
                        function(a, b) {
                            ba.trigger(o.JWPLAYER_CAST_SESSION, b)
                        }),
                        V.on("change:fullscreen",
                        function(a, b) {
                        ...
                        V.on("change:controls",
                        function(a, b) {
                            ba.trigger(o.JWPLAYER_CONTROLS, {
                                controls: b
                            })
                        }),
                        V.on("change:scrubbing",
                        function(a, b) {
                            b ? y() : w()
                        }),
                        V.on("change:captionsList",
                        function(a, b) {
                    ...
                    function u(a) {
                        var b = new i;
                        b.on(o.JWPLAYER_PLAYLIST_LOADED,
                        function(a) {
                            t(a.playlist)
                        }),
                        b.on(o.JWPLAYER_ERROR,
                        function(a) {
                    ...
                    function w() {
                        ...
                        if (V.get("state") !== n.ERROR) {
                            ...
                            if (V.get("state") === n.COMPLETE && (x(!0), D(0)), !_ && (_ = !0, ba.trigger(o.JWPLAYER_MEDIA_BEFOREPLAY, {}), _ = !1, $)) return $ = !1,
                            void(Z = null);
                            if (z()) {
                    ...
                    function y() {
                        ...
                        case n.BUFFERING:
                            ...
                            this);
                            if (b instanceof j.Error) return ba.triggerError(b),
                            !1;
                            break;
                        default:
                            _ && ($ = !0)
                    ...
                    function C(a) {
                        var b = h(a);
                        return b = h.filterPlaylist(b, V.getProviders(), V.get("androidhls"), V.get("drm"), V.get("preload")),
                        V.set("playlist", b),
                        d.isArray(b) && 0 !== b.length ? !0 : (ba.triggerError({
                    ...
                    V.mediaController.on(o.JWPLAYER_MEDIA_COMPLETE,
                    function() {
                        d.defer(G)
                    }),
                    V.mediaController.on(o.JWPLAYER_MEDIA_ERROR, this.triggerError, this),
                    V.on("change:flashBlocked",
                    function(a, b) {
                        ...
                        c || this.trigger(o.JWPLAYER_ERROR, d),
                    ...
                    this.setControls = function(a) {
                        d.isBoolean(a) || (a = !V.get("controls")),
                        V.set("controls", a);
                        var b = V.getVideo();
                        b && b.setControls(a)
                    },
            ...
            k = function() {
                function g(a, b) {
                    ...
                    case "flashThrottle":
                        ...
                        this.set("flashThrottle", c),
                        this.set("flashBlocked", c);
                        break;
                    case "flashBlocked":
                ...
                this.changeVideoProvider = function(a) {
                    ...
                    -1 === o.getName().name.indexOf("flash") && (this.set("flashThrottle", void 0), this.set("flashBlocked", !1)),
                    m = o,
        ...
        e = function(a, b, c, d, e, f, g, h) {
            ...
            function l(l, v) {
                ...
                function z() {
                    m(ia),
                    ga = !0,
                    ka && (ea.state === f.STALLED ? ea.setState(f.PLAYING) : ea.state === f.PLAYING && (ia = setTimeout(T, n)), C(qa.duration), B(qa.currentTime), A(U(), ba, aa), ea.state === f.PLAYING && ea.trigger(e.JWPLAYER_MEDIA_TIME, {
                        position: ba,
                        duration: aa
                    }))
                }

                function A(a, b, c) { (a !== ja || c !== aa) && (ja = a, ea.trigger(e.JWPLAYER_MEDIA_BUFFER, {
                        bufferPercent: 100 * a,
                        position: b,
                        duration: c
                    }))
                ...
                function H() {
                    ea.setState(f.PLAYING),
                    ea.trigger(e.JWPLAYER_PROVIDER_FIRST_FRAME, {})
                }
                ...
                function M(a) {
                    ...
                    la = N(a);
                    var b = L(a);
                    b && ea.trigger(e.JWPLAYER_MEDIA_LEVELS, {
                        levels: b,
                        currentQuality: la
                    })
                }
                ...
                function P(a, c) {
                    ...
                    m(ia);
                    var d = qa.src !== _.file;
                    d || O() ? (aa = c, Q(), qa.load()) : (0 === a && 0 !== qa.currentTime && (ha = -1, ea.seek(a)), qa.play()),
                    ba = qa.currentTime,
                    p && (G(), qa.paused || ea.state === f.PLAYING || ea.setState(f.LOADING)),
                    b.isIOS() && ea.getFullScreen() && (qa.controls = !0),
                    a > 0 && ea.seek(a)
                }
                ...
                function Q() {
                    ...
                    ma = k(_),
                    qa.src = _.file,
                    _.preload && qa.setAttribute("preload", _.preload)
                }

                function R() {
                    ea.seeking = !1,
                    ea.trigger(e.JWPLAYER_MEDIA_SEEKED)
                }

                function S() {
                    ea.trigger("volume", {
                        volume: Math.round(100 * qa.volume)
                    }),
                    ea.trigger("mute", {
                        mute: qa.muted
                    })
                ...
                function W() {
                    m(ia),
                    ea.setState(f.COMPLETE),
                    na = !1,
                    ea.trigger(e.JWPLAYER_MEDIA_COMPLETE)
                }

                function X(a) {
                    oa = !0,
                    Z(a),
                    b.isIOS() && (qa.controls = !1)
                }
                ...
                na = !1,
                oa = !1,
                pa = document.getElementById(l),
                qa = pa ? pa.querySelector("video") : void 0;
                qa = qa || document.createElement("video"),
                qa.className = "jw-video jw-reset",
                i(fa, qa),
                t || (qa.controls = !0, qa.controls = !1),
                qa.setAttribute("x-webkit-airplay", "allow"),
                qa.setAttribute("webkit-playsinline", ""),
                this.stop = function() {
                    m(ia),
                    ka && (qa.removeAttribute("src"), o || qa.load(), b.isIETrident() && qa.pause(), la = -1, this.setState(f.IDLE))
                },
                this.destroy = function() {
                    j(fa, qa),
                    this.remove(),
                ...
                this.remove = function() {
                    qa && (qa.removeAttribute("src"), o || qa.load()),
                    m(ia),
                    la = -1,
                    $ === qa.parentNode && $.removeChild(qa)
                },
                ...
                this.setCurrentQuality = function(a) {
                    if (la !== a && (a = parseInt(a, 10), a >= 0 && da && da.length > a)) {
                        ...
                        var b = qa.currentTime || 0,
                        c = qa.duration || 0;
                        0 >= c && (c = aa),
                        ea.setState(f.LOADING),
                        P(b, c)
                    }
                },
        ...
        e = function(a, b, c, d, e, f, g) {
            ...
            function j(j, k) {
                ...
                function m(a) {
                    ...
                    if (!b) {
                        for (var c = 1 / 0,
                        d = C.bitrates.length; d--;) {
                            var e = Math.abs(C.bitrates[d] - a);
                            if (e > c) break;
                            c = e
                        }
                        b = C.labels[C.bitrates[d + 1]],
                        C[a] = b
                    }
                    return b
                }
                ...
                b.extend(this, g, {
                    ...
                    attachMedia: function() {
                        y = !0,
                        t && (this.setState(d.COMPLETE), this.trigger(c.JWPLAYER_MEDIA_COMPLETE), t = !1)
                    },
                    ...
                    setContainer: function(e) {
                        if (o !== e) {
                            ...
                            function() {
                                clearTimeout(s),
                                g.trigger.call(f, "flashUnblocked")
                            },
                            this),
                            p.once("ready",
                            function() {
                                clearTimeout(s),
                                p.once("pluginsLoaded",
                                function() {
                                    p.queueCommands = !1,
                                    B("setupCommandQueue", p.__commandQueue),
                                    p.__commandQueue = []
                                });
                                var a = b.extend({},
                                k),
                                d = p.triggerFlash("setup", a);
                                d === p ? p.__ready = !0 : this.trigger(c.JWPLAYER_MEDIA_ERROR, d),
                                r && B("init", r)
                            },
                            this);
                            ...
                            j = [c.JWPLAYER_MEDIA_BUFFER, c.JWPLAYER_MEDIA_TIME],
                            m = [c.JWPLAYER_MEDIA_BUFFER_FULL];
                            p.on(c.JWPLAYER_MEDIA_LEVELS,
                            function(a) {
                                l(a.levels),
                                u = a.currentQuality,
                                v = a.levels,
                            ...
                            this),
                            p.on(c.JWPLAYER_MEDIA_LEVEL_CHANGED,
                            function(a) {
                                l(a.levels),
                                u = a.currentQuality,
                                v = a.levels,
                            ...
                            this),
                            p.on(c.JWPLAYER_AUDIO_TRACK_CHANGED,
                            function(a) {
                                w = a.currentTrack,
                                x = a.tracks,
                                this.trigger(a.type, a)
                            ...
                            this),
                            p.on(c.JWPLAYER_MEDIA_BEFORECOMPLETE,
                            function(a) {
                                t = !0,
                                this.trigger(a.type),
                                y === !0 && (t = !1)
                            ...
                            this),
                            p.on(c.JWPLAYER_MEDIA_COMPLETE,
                            function(a) {
                            ...
                            this),
                            p.on(c.JWPLAYER_PROVIDER_CHANGED,
                            function(a) {
                                q = a.message,
                                this.trigger(c.JWPLAYER_PROVIDER_CHANGED, a)
                            },
                            this),
                            p.on(c.JWPLAYER_ERROR,
                            function(b) {
                            ...
                            function(a) {
                                clearTimeout(s),
                                "resume" === a.state ? g.trigger.call(f, "flashThrottle", a) : s = setTimeout(function() {
        ...
        e = function(a, b, c) {
            ...
            function e(e, f, i, j) {
                ...
                if (j = j || "opaque", a.isMSIE()) {
                    ...
                    f.appendChild(l),
                    l.outerHTML = "<object classid=\"clsid:D27CDB6E-AE6D-11cf-96B8-444553540000\" width=\"100%\" height=\"100%\" id=\"" + i + "\" name=\"" + i + "\" tabindex=\"0\"><param name=\"movie\" value=\"" + e + "\"><param name=\"allowfullscreen\" value=\"true\"><param name=\"allowscriptaccess\" value=\"always\"><param name=\"wmode\" value=\"" + j + "\"><param name=\"bgcolor\" value=\"" + h + "\"><param name=\"menu\" value=\"false\"></object>";
                    for (var m = f.getElementsByTagName("object"), n = m.length; n--;) m[n].id === i && (k = m[n])
                } else k = document.createElement("object"),
                k.setAttribute("type", "application/x-shockwave-flash"),
                k.setAttribute("data", e),
                k.setAttribute("width", "100%"),
                k.setAttribute("height", "100%"),
                k.setAttribute("bgcolor", h),
                k.setAttribute("id", i),
                k.setAttribute("name", i),
                d(k, "allowfullscreen", "true"),
                d(k, "allowscriptaccess", "always"),
                d(k, "wmode", j),
                d(k, "menu", "false"),
                f.appendChild(k, f);
                return k.className = "jw-swf jw-reset",
    ...
    function(a, b, c) {
        ...
        e = function(a, b, d, e, f, g) {
            ...
            function j(b, c) {
                ...
                c.set("edition", f),
                c.updateProviders(),
                "invalid" === f ? g.error(b, "Error setting up player", (void 0 === d ? "Missing": "Invalid") + " license key") : b()
            }
    ...
    function(a, b, c) {
        ...
        e = function(a, b, d, e, f, g, h) {
            ...
            function k(a) {
                window.btoa && window.atob ? a() : c.e(2,
                function(b) {
                    c(105),
                    a()
                })
            ...
            function p(a, c) {
                ...
                f.isString(d) ? (A = new b, A.on(h.JWPLAYER_PLAYLIST_LOADED,
                function(b) {
                    c.set("playlist", b.playlist),
                    a()
        ...
        e = function(a, b, c, d) {
            ...
            f.filterPlaylist = function(a, b, d, e, f) {
                ...
                function(a) {
                    ...
                    a.sources.length && (a.file = a.sources[0].file, (a.preload || f) && (a.preload = a.preload || f), i.push(a))
                }),
                i
            };
            ...
            var d = function(d, e) {
                ...
                return f.setup = function() {
                    if (g.call(this), "trial" === e.get("edition")) {
                        var a = document.createElement("div");
                        a.className = "jw-icon jw-watermark",
    ...
    function(a, b, c) {
        var d, e;
        d = [c(47), c(45), c(46), c(61), c(128), c(129), c(130), c(132), c(118), c(134), c(148), c(149), c(152), c(44), c(153)],
        e = function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
            ...
            t = function(t, u) {
                ...
                function A() {
                    var a = !Ja;
                    Ja = !1,
                    a && Ka.trigger(b.JWPLAYER_VIEW_TAB_FOCUS, {
                        hasFocus: !0
                    }),
                    Fa || _()
                }
                ...
                function D(b, c) {
                    c = c || !1,
                    a.toggleClass(ha, "jw-flag-casting", c)
                }
                ...
                function F(b, c, d) {
                    d && a.removeClass(ha, "jw-stretch-" + d),
                    a.addClass(ha, "jw-stretch-" + c)
                }
                ...
                function I() {
                    u.get("state") !== d.IDLE && u.get("state") !== d.COMPLETE && u.get("state") !== d.PAUSED || !u.get("controls") || t.play(),
                    Ga ? $() : _()
                }
                ...
                function P() {
                    ...
                    a.isChrome() && c.el.addEventListener("mousedown",
                    function() {
                        var a = u.getVideo(),
                    ...
                    var k = u.get("height");
                    r && ("string" == typeof k || k >= 1.5 * Ea) ? a.addClass(ha, "jw-flag-touch") : (xa = new l, xa.setup(u, ha, ha)),
                    oa = new j(t, u),
                ...
                function R(b, c) {
                    ...
                    c ? a.addClass(ha, "jw-flag-dragging") : Q(b)
                }

                function S(b, c, d) {
                    var e, f = ha.className;
                    d = !!d,
                    d && (f = f.replace(/\s*aspectMode/, ""), ha.className !== f && (ha.className = f), a.style(ha, {
                        display: "block"
                    },
                    d)),
                    ...
                    p(ha, e, !0),
                    ta && ta.offset(oa && ta.position().indexOf("bottom") >= 0 ? oa.element().clientHeight: 0),
                    T(c),
                    W(b, c)
                }
                ...
                function da(b, c) {
                    ...
                    a.toggleClass(ha, "jw-flag-live", d),
                    Ka.setAltText(d ? "Live Broadcast": "")
                }
                ...
                Aa = ha.requestFullscreen || ha.webkitRequestFullscreen || ha.webkitRequestFullScreen || ha.mozRequestFullScreen || ha.msRequestFullscreen,
                Ba = document.exitFullscreen || document.webkitExitFullscreen || document.webkitCancelFullScreen || document.mozCancelFullScreen || document.msExitFullscreen,
                Ia = Aa && Ba,
                this.onChangeSkin = function(b, c, d) {
                    d && a.removeClass(ha, "jw-skin-" + d),
                    c && a.addClass(ha, "jw-skin-" + c)
                },
                ...
                this.setup = function() {
                    ...
                    u.get("skin-loading") === !0 && (a.addClass(ha, "jw-flag-skin-loading"), u.once("change:skin-loading",
                    function() {
                    ...
                    r || (qa.element().addEventListener("mouseout", _, !1), qa.element().addEventListener("mousemove", _, !1)),
                    H(oa),
                    H(ta),
                    u.get("aspectratio") && (a.addClass(ha, "jw-flag-aspect-mode"), a.style(ka, {
                        "padding-top": u.get("aspectratio")
                    })),
                    t.on(b.JWPLAYER_READY,
                    function() {
                        C(),
                ...
                Oa = function(b, c) {
                    var d = u.getVideo();
                    Ia ? (c ? Aa.apply(ha) : Ba.apply(document), Z(ha, c)) : a.isIE() ? Z(ha, c) : (na && na.getVideo() && na.getVideo().setFullscreen(c), d.setFullscreen(c)),
                ...
                this.resizeMedia = W,
                this.reset = function() {
                    document.contains(ha) && ha.parentNode.replaceChild(za, ha),
                    a.emptyElement(ha)
                },
                ...
                this.destroyInstream = function() {
                    ...
                    da(u, u.get("duration")),
                    qa.revertAlternateClickHandlers()
                },
                ...
                this.getSafeRegion = function(b) {
                    ...
                    d = u.get("dock");
                    return d && d.length && u.get("controls") && (c.y = sa.element().clientHeight, c.height -= c.y),
                    b = b || !a.exists(b),
                ...
                this.destroy = function() {
                    ...
                    ia && (qa.element().removeEventListener("mousemove", _), qa.element().removeEventListener("mouseout", _)),
    ...
    function(a, b, c) {
        ...
        e = function(a, b, c, d) {
            ...
            l = d.isFF() && d.isOSX(),
            m = function(a, d) {
                function j(a) { (k || i && "touch" !== a.pointerType) && q(b.touchEvents.OVER, a)
                }

                function m(c) { (k || i && "touch" !== c.pointerType && !a.contains(document.elementFromPoint(c.x, c.y))) && q(b.touchEvents.OUT, c)
                }
                ...
                function n(b) {
                    ...
                    v = e(b, "X"),
                    w = e(b, "Y"),
                    f(b) || (i ? b.isPrimary && (d.preventScrolling && (s = b.pointerId, a.setPointerCapture(s)), a.addEventListener("pointermove", o), a.addEventListener("pointerup", p), a.addEventListener("pointercancel", p)) : k && (document.addEventListener("mousemove", o), l && "object" === b.target.nodeName.toLowerCase() ? a.addEventListener("click", p) : document.addEventListener("mouseup", p)), r.addEventListener("touchmove", o), r.addEventListener("touchend", p), r.addEventListener("touchcancel", p))
                }
                ...
                function p(c) {
                    var e = b.touchEvents;
                    i ? (d.preventScrolling && a.releasePointerCapture(s), a.removeEventListener("pointermove", o), a.removeEventListener("pointercancel", p), a.removeEventListener("pointerup", p)) : k && (document.removeEventListener("mousemove", o), document.removeEventListener("mouseup", p)),
                    r.removeEventListener("touchmove", o),
                    r.removeEventListener("touchcancel", p),
                    r.removeEventListener("touchend", p),
                    u ? q(e.DRAG_END, c) : d.directSelect && c.target !== a || (i && c instanceof window.PointerEvent ? "touch" === c.pointerType ? q(e.TAP, c) : q(e.CLICK, c) : k ? q(e.CLICK, c) : (q(e.TAP, c), h(c))),
                    r = null,
                    u = !1
                }
                ...
                y = 300;
                d = d || {},
                i ? (a.addEventListener("pointerdown", n), d.useHover && (a.addEventListener("pointerover", j), a.addEventListener("pointerout", m))) : k && (a.addEventListener("mousedown", n), d.useHover && (a.addEventListener("mouseover", j), a.addEventListener("mouseout", m))),
                a.addEventListener("touchstart", n);
                var z = this;
                return this.triggerEvent = q,
                this.destroy = function() {
                    a.removeEventListener("touchstart", n),
                    a.removeEventListener("mousedown", n),
                    r && (r.removeEventListener("touchmove", o), r.removeEventListener("touchcancel", p), r.removeEventListener("touchend", p)),
                    i && (d.preventScrolling && a.releasePointerCapture(s), a.removeEventListener("pointerdown", n), a.removeEventListener("pointermove", o), a.removeEventListener("pointercancel", p), a.removeEventListener("pointerup", p)),
    ...
    function(a, b, c) {
        ...
        e = function(a, b, c, d) {
            ...
            g = function(g) {
                ...
                this.setup = function(a) {
                    if (r = document.createElement("div"), s = document.createElement("span"), r.className = "jw-captions-window jw-reset", s.className = "jw-captions-text jw-reset", t = d.extend({},
                    f, a), a) {
                        var c = t.fontOpacity,
                        h = t.windowOpacity,
                        i = t.edgeStyle,
                        ...
                        m(i, l, c),
                        t.back ? l.backgroundColor = b.hexToRgba(j, t.backgroundOpacity) : null === i && m("uniform", l),
                        e(r, k),
                        e(s, l)
                    }
                    r.appendChild(s),
    ...
    function(a, b, c) {
        ...
        a.exports = (d["default"] || d).template({
            1 : function(a, b, c, d) {
                ...
                null != e && (j += e),
                j += "\" button=\"" + i((f = null != (f = b.id || (null != a ? a.id: a)) ? f: h, typeof f === g ? f.call(a, {
                    name: "id",
                    hash: {},
                    data: d
        ...
        e = function(a, b, c) {
            ...
            var e = {
                ...
                loadThumbnail: function(b) {
                    ...
                    return d.backgroundImage = "url(\"" + c + "\")",
                    d
                },
        ...
        e = function(a, b, c, d, e) {
            ...
            return c.extend(f.prototype, {
                buildArray: function() {
                    ...
                    d = {
                        items: [{
                            title: "Powered by xksoft.com",
                            featured: !0,
                            showLogo: !0,
                            link: "http://www.xiake.net"
                        }]
                    },
                    f = c.indexOf("-") > 0,
                    g = b[1];
                    ...
                    if (i.indexOf("flash") >= 0) {
                        ...
                        d.items.push({
                            title: j,
                            link: "http://www.adobe.com/software/flash/videoplayer/"
                        })
                    }
                    return d
                },
    ...
    function(a, b, c) {
        var d, e;
        d = [c(41), c(44), c(59), c(47), c(89), c(51), c(119), c(95), c(101), c(96), c(83), c(45), c(61), c(114), c(69), c(161), c(66), c(98)],
